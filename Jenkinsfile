...
//             sh 'pmd -d -f txt -r rulesets/java/quickstart.xml -reportfile report.txt'}}
      ...
      stage ("Archery Sync"){
        ...
        sh 'archerysec-cli -h http://localhost:8000 -t sUX5oFWhz5jYYkJ35-Ssv1872d7cd3qN7A2hpeRBVN7Wzayx05r9cG_5k2Lf8XaX --cicd_id=2b5eceda-75ba-4ad8-a219-4c8da3c72f77 --project=b8296cd8-4717-4ee1-b178-248d5bcbfeb1 --bandit --report_path=$(pwd)'}
        }
}
}
